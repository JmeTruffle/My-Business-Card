  ...
  return (
    <div className={styles.wrapper}>
      ...
      <svg
        width='15'
        height='23'
        className={`${styles.shape} ${styles.s4}`}
        xmlns='http://www.w3.org/2000/svg'
      >
        <rect
      ...
      <svg
        width='15'
        height='23'
        className={`${styles.shape} ${styles.s5}`}
        xmlns='http://www.w3.org/2000/svg'
      >
        <rect
          transform='rotate(30 9.86603 10.13397)'
      ...
      <svg
        width='49'
        height='17'
        className={`${styles.shape} ${styles.s6}`}
        xmlns='http://www.w3.org/2000/svg'
      >
      ...
      <svg
        width='26'
        height='26'
        className={`${styles.shape} ${styles.s7}`}
        xmlns='http://www.w3.org/2000/svg'
      >
        <path
      ...
      <svg
        width='19'
        height='21'
        className={`${styles.shape} ${styles.s8}`}
        xmlns='http://www.w3.org/2000/svg'
      >
        <rect
      ...
      <svg
        width='30'
        height='25'
        className={`${styles.shape} ${styles.s9}`}
        xmlns='http://www.w3.org/2000/svg'
      >
        <path
      ...
      <svg
        width='47'
        height='29'
        className={`${styles.shape} ${styles.s10}`}
        xmlns='http://www.w3.org/2000/svg'
      >
      ...
      <svg
        width='33'
        height='20'
        className={`${styles.shape} ${styles.s11}`}
        xmlns='http://www.w3.org/2000/svg'
      >
        <path
